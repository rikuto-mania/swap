...
export default function Actions(){
    return(
        <div>
            ...
            <p className="text-main text-4xl font-bold">our activities</p>

            <div className="px-5.5 py-8 flex flex-wrap gap-10">
                <Link href={"/actions"} className="w-[cale((100%-80px)/3)]">
            ...
            <div className="text-center"><Link href={"/"} className="bg-main text-white py-4 px-20 rounded-full">show more</Link></div>
            </section>
        </div>
    );
};  